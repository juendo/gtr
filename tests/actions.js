  ...
  describe('actions', function () {
    ...
    describe('scoring', function() {
      ...
      it('should give add points for vault', function() {
        player1.vault.push({color: 'green'});
        player2.vault.push({color: 'green'});
        player3.vault.push({color: 'green'});
        actions.checkIfGameOver(game, meta);
      ...
      it('should add actions.merchant bonus points for multiple materials', function() {
        player1.vault.push({color: 'green'});
        player1.vault.push({color: 'blue'});
        player1.vault.push({color: 'purple'});
        player2.vault.push({color: 'green'});
        player2.vault.push({color: 'green'});
        player2.vault.push({color: 'green'});
        player3.vault.push({color: 'green'});
        player3.vault.push({color: 'green'});
        player3.vault.push({color: 'yellow'});
        actions.checkIfGameOver(game, meta);
